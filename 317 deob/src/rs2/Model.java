...
public final class Model extends Animable {
	...
	public static void method460(byte abyte0[], int j) {
		...
		class21_1.anInt369 = stream.getShort();
		class21_1.anInt370 = stream.getShort();
		class21_1.anInt371 = stream.getUByte();
	...
	private Model(int i) {
		...
		stream.offset = class21.anInt379;
		stream_1.offset = class21.anInt380;
		stream_2.offset = class21.anInt381;
		stream_3.offset = class21.anInt382;
		stream_4.offset = class21.anInt383;
		for (int l1 = 0; l1 < anInt1630; l1++) {
			anIntArray1640[l1] = stream.getShort();
			if (anIntArray1637 != null)
				anIntArray1637[l1] = stream_1.getUByte();
		...
		stream.offset = class21.anInt377;
		stream_1.offset = class21.anInt378;
		int j2 = 0;
		int l2 = 0;
		int j3 = 0;
		int k3 = 0;
		...
		stream.offset = class21.anInt384;
