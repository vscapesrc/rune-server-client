...
public final class Texture extends RSDrawingArea {
	...
	public static void method364() {
		anIntArray1472 = new int[RSDrawingArea.height];
		for (int j = 0; j < RSDrawingArea.height; j++)
			anIntArray1472[j] = RSDrawingArea.width * j;

		textureInt1 = RSDrawingArea.width / 2;
		textureInt2 = RSDrawingArea.height / 2;
	}
	...
	public static void method368(CacheArchive streamLoader) {
		...
		for (int j = 0; j < 50; j++)
			try {
				aBackgroundArray1474s[j] = new IndexedImage(streamLoader,
						String.valueOf(j), 0);
	...
	private static int[] method371(int i) {
		...
		IndexedImage background = aBackgroundArray1474s[i];
	...
	public static void method376(int i, int j, int k, int l, int i1, int j1,
		...
		if (i <= j && i <= k) {
			...
			if (j < k) {
				...
				if (i != j && j2 < l1 || i == j && j2 > i2) {
					...
					j -= i;
					for (i = anIntArray1472[i]; --j >= 0; i += RSDrawingArea.width) {
						method377(RSDrawingArea.pixels, i, k1, j1 >> 16, l >> 16);
						j1 += j2;
						l += l1;
					}

					while (--k >= 0) {
						method377(RSDrawingArea.pixels, i, k1, j1 >> 16, i1 >> 16);
						j1 += j2;
						i1 += i2;
						i += RSDrawingArea.width;
					}
				...
				j -= i;
				for (i = anIntArray1472[i]; --j >= 0; i += RSDrawingArea.width) {
					method377(RSDrawingArea.pixels, i, k1, l >> 16, j1 >> 16);
					j1 += j2;
					l += l1;
				}

				while (--k >= 0) {
					method377(RSDrawingArea.pixels, i, k1, i1 >> 16, j1 >> 16);
					j1 += j2;
					i1 += i2;
					i += RSDrawingArea.width;
				}
			...
			if (i != k && j2 < l1 || i == k && i2 > l1) {
				...
				k -= i;
				for (i = anIntArray1472[i]; --k >= 0; i += RSDrawingArea.width) {
					method377(RSDrawingArea.pixels, i, k1, i1 >> 16, l >> 16);
					i1 += j2;
					l += l1;
				}
			...
			k -= i;
			for (i = anIntArray1472[i]; --k >= 0; i += RSDrawingArea.width) {
				method377(RSDrawingArea.pixels, i, k1, l >> 16, i1 >> 16);
				i1 += j2;
				l += l1;
			}
		...
		if (j <= k) {
			...
			if (k < i) {
				...
				if (j != k && l1 < i2 || j == k && l1 > j2) {
					...
					k -= j;
					for (j = anIntArray1472[j]; --k >= 0; j += RSDrawingArea.width) {
						method377(RSDrawingArea.pixels, j, k1, l >> 16, i1 >> 16);
						l += l1;
						i1 += i2;
					}

					while (--i >= 0) {
						method377(RSDrawingArea.pixels, j, k1, l >> 16, j1 >> 16);
						l += l1;
						j1 += j2;
						j += RSDrawingArea.width;
					}
				...
				k -= j;
				for (j = anIntArray1472[j]; --k >= 0; j += RSDrawingArea.width) {
					method377(RSDrawingArea.pixels, j, k1, i1 >> 16, l >> 16);
					l += l1;
					i1 += i2;
				}

				while (--i >= 0) {
					method377(RSDrawingArea.pixels, j, k1, j1 >> 16, l >> 16);
					l += l1;
					j1 += j2;
					j += RSDrawingArea.width;
				}
			...
			if (l1 < i2) {
				...
				i -= j;
				for (j = anIntArray1472[j]; --i >= 0; j += RSDrawingArea.width) {
					method377(RSDrawingArea.pixels, j, k1, j1 >> 16, i1 >> 16);
					j1 += l1;
					i1 += i2;
				}
			...
			i -= j;
			for (j = anIntArray1472[j]; --i >= 0; j += RSDrawingArea.width) {
				method377(RSDrawingArea.pixels, j, k1, i1 >> 16, j1 >> 16);
				j1 += l1;
				i1 += i2;
			}
		...
		if (i < j) {
			...
			if (i2 < j2) {
				...
				i -= k;
				for (k = anIntArray1472[k]; --i >= 0; k += RSDrawingArea.width) {
					method377(RSDrawingArea.pixels, k, k1, i1 >> 16, j1 >> 16);
					i1 += i2;
					j1 += j2;
				}

				while (--j >= 0) {
					method377(RSDrawingArea.pixels, k, k1, i1 >> 16, l >> 16);
					i1 += i2;
					l += l1;
					k += RSDrawingArea.width;
				}
			...
			i -= k;
			for (k = anIntArray1472[k]; --i >= 0; k += RSDrawingArea.width) {
				method377(RSDrawingArea.pixels, k, k1, j1 >> 16, i1 >> 16);
				i1 += i2;
				j1 += j2;
			}

			while (--j >= 0) {
				method377(RSDrawingArea.pixels, k, k1, l >> 16, i1 >> 16);
				i1 += i2;
				l += l1;
				k += RSDrawingArea.width;
			}
		...
		if (i2 < j2) {
			...
			j -= k;
			for (k = anIntArray1472[k]; --j >= 0; k += RSDrawingArea.width) {
				method377(RSDrawingArea.pixels, k, k1, l >> 16, j1 >> 16);
				l += i2;
				j1 += j2;
			}
		...
		j -= k;
		for (k = anIntArray1472[k]; --j >= 0; k += RSDrawingArea.width) {
			method377(RSDrawingArea.pixels, k, k1, j1 >> 16, l >> 16);
			l += i2;
			j1 += j2;
		}
	...
	public static void method378(int i, int j, int k, int l, int i1, int j1,
		...
		if (i <= j && i <= k) {
			...
			if (j < k) {
				...
				if (i != j && i8 < i7 || i == j && i8 > k7) {
					...
					i = anIntArray1472[i];
					while (--j >= 0) {
						method379(RSDrawingArea.pixels, ai, i, j1 >> 16, l >> 16,
					...
					while (--k >= 0) {
						method379(RSDrawingArea.pixels, ai, i, j1 >> 16,
				...
				i = anIntArray1472[i];
				while (--j >= 0) {
					method379(RSDrawingArea.pixels, ai, i, l >> 16, j1 >> 16,
				...
				while (--k >= 0) {
					method379(RSDrawingArea.pixels, ai, i, i1 >> 16, j1 >> 16,
			...
			if (i != k && i8 < i7 || i == k && k7 > i7) {
				...
				i = anIntArray1472[i];
				while (--k >= 0) {
					method379(RSDrawingArea.pixels, ai, i, i1 >> 16, l >> 16,
			...
			i = anIntArray1472[i];
			while (--k >= 0) {
				method379(RSDrawingArea.pixels, ai, i, l >> 16, i1 >> 16,
		...
		if (j <= k) {
			...
			if (k < i) {
				...
				if (j != k && i7 < k7 || j == k && i7 > i8) {
					...
					j = anIntArray1472[j];
					while (--k >= 0) {
						method379(RSDrawingArea.pixels, ai, j, l >> 16, i1 >> 16,
								k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
						l += i7;
						i1 += k7;
						k1 += j7;
					...
					while (--i >= 0) {
						method379(RSDrawingArea.pixels, ai, j, l >> 16, j1 >> 16,
								k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
						l += i7;
						j1 += i8;
						k1 += j7;
				...
				j = anIntArray1472[j];
				while (--k >= 0) {
					method379(RSDrawingArea.pixels, ai, j, i1 >> 16, l >> 16,
							l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					i1 += k7;
					k1 += j7;
				...
				while (--i >= 0) {
					method379(RSDrawingArea.pixels, ai, j, j1 >> 16, l >> 16,
							i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					j1 += i8;
					k1 += j7;
			...
			if (i7 < k7) {
				...
				j = anIntArray1472[j];
				while (--i >= 0) {
					method379(RSDrawingArea.pixels, ai, j, j1 >> 16, i1 >> 16,
			...
			j = anIntArray1472[j];
			while (--i >= 0) {
				method379(RSDrawingArea.pixels, ai, j, i1 >> 16, j1 >> 16,
						l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
				j1 += i7;
				i1 += k7;
				i2 += j7;
		...
		if (i < j) {
			...
			if (k7 < i8) {
				...
				k = anIntArray1472[k];
				while (--i >= 0) {
					method379(RSDrawingArea.pixels, ai, k, i1 >> 16, j1 >> 16,
							l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += k7;
					j1 += i8;
					l1 += l7;
				...
				while (--j >= 0) {
					method379(RSDrawingArea.pixels, ai, k, i1 >> 16, l >> 16,
							l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += k7;
					l += i7;
					l1 += l7;
			...
			k = anIntArray1472[k];
			while (--i >= 0) {
				method379(RSDrawingArea.pixels, ai, k, j1 >> 16, i1 >> 16,
						i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				j1 += i8;
				l1 += l7;
			...
			while (--j >= 0) {
				method379(RSDrawingArea.pixels, ai, k, l >> 16, i1 >> 16,
						k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				l += i7;
				l1 += l7;
		...
		if (k7 < i8) {
			...
			k = anIntArray1472[k];
			while (--j >= 0) {
				method379(RSDrawingArea.pixels, ai, k, l >> 16, j1 >> 16,
						k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
				l += k7;
				j1 += i8;
				k1 += l7;
		...
		k = anIntArray1472[k];
		while (--j >= 0) {
			method379(RSDrawingArea.pixels, ai, k, j1 >> 16, l >> 16, i2 >> 8,
		...
		while (--i >= 0) {
			method379(RSDrawingArea.pixels, ai, k, j1 >> 16, i1 >> 16, i2 >> 8,
