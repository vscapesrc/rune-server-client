...
public final class Class36 {
	...
	public static void method529(byte abyte0[]) {
		...
		stream.offset = abyte0.length - 8;
		int i = stream.getShort();
		int j = stream.getShort();
		int k = stream.getShort();
		int l = stream.getShort();
		int i1 = 0;
		ByteBuffer stream_1 = new ByteBuffer(abyte0);
		stream_1.offset = i1;
		i1 += i + 2;
		ByteBuffer stream_2 = new ByteBuffer(abyte0);
		stream_2.offset = i1;
		i1 += j;
		ByteBuffer stream_3 = new ByteBuffer(abyte0);
		stream_3.offset = i1;
		i1 += k;
		ByteBuffer stream_4 = new ByteBuffer(abyte0);
		stream_4.offset = i1;
		i1 += l;
		ByteBuffer stream_5 = new ByteBuffer(abyte0);
		stream_5.offset = i1;
		...
		for (int l1 = 0; l1 < k1; l1++) {
			...
			class36.anInt636 = stream_4.getUByte();
