	...
	public void updatePlayer(ByteBuffer buffer) {
		...
		for (int j = 0; j < 12; j++) {
			...
			if (j == 0 && equipment[0] == 65535) {
				desc = NPCDef.getNPC(buffer.getShort());
				break;
			}
		...
		super.anInt1511 = buffer.getShort();
		if (super.anInt1511 == 65535)
			super.anInt1511 = -1;
		super.anInt1512 = buffer.getShort();
		if (super.anInt1512 == 65535)
			super.anInt1512 = -1;
		super.anInt1554 = buffer.getShort();
		if (super.anInt1554 == 65535)
			super.anInt1554 = -1;
		super.anInt1555 = buffer.getShort();
		if (super.anInt1555 == 65535)
			super.anInt1555 = -1;
		super.anInt1556 = buffer.getShort();
		if (super.anInt1556 == 65535)
			super.anInt1556 = -1;
		super.anInt1557 = buffer.getShort();
