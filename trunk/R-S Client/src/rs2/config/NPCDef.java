...
public final class NPCDef {
	...
	public static NPCDef getDef(int i) {
		for (int j = 0; j < 20; j++)
	...
	public Model method164(int j, int k, int ai[]) {
		...
		model_1.method464(model, FrameHeader.method532(k) & FrameHeader.method532(j));
		if (k != -1 && j != -1)
	...
	public static MemCache mruNodes = new MemCache(30);
